...
'''
Next, we set up any callback functions that we want to be run in the update cycle. In our case, we want to create an animation, 
so we call register_animation_callback(rotate_around) , where rotate_around is the name of the function.
 The same thing can be done with keyboard and mouse callbacks. The function is shown below.
'''
